...
<footer 
  className="flex flex-col items-center bg-gradient-to-r from-black to-indigo-500 
  text-center text-surface dark:bg-neutral-700 md:mt-[500px] md:w-full   text-white  dark:text-white">
